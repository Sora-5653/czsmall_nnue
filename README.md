...
**270 tests, ~750k assertions**, clean under `-Werror`, AddressSanitizer and
...
Without them those two tests skip and the other 268 still run.
...
tests/              270 tests, dependency-free harness
