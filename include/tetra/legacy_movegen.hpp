...
// TetraFormer / TetraZero -- compatibility action and timing layer.
//
...
public:
    ...
    LegacyMoveGenerator() = default;
    explicit LegacyMoveGenerator(const Options& o) : opt_(o) {}
